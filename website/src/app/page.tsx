      ...
      <main>
        <section className="max-w-5xl mx-auto px-4 md:px-6 py-8 md:py-12 text-center">
          ...
          <div className="flex flex-wrap gap-2 md:gap-3 justify-center px-4">
            ...
            <a
              href="https://oshoworld.com/maha-geeta-by-osho-01-91"
              target="_blank"
              rel="noopener noreferrer"
               className="px-5 md:px-6 py-2.5 md:py-3 border border-stone-300 dark:border-stone-600 text-stone-700 dark:text-stone-200 rounded-full text-sm font-medium hover:border-stone-400 dark:hover:border-stone-500 hover:bg-stone-50 dark:hover:bg-stone-800 transition-colors inline-flex items-center gap-1.5"
            >
